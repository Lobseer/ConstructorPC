...
{
    public class GraphicCardDao : AbstractDao<GraphicCard, int>, IGraphicCardDao
    {
        ...
        protected override GraphicCard parseDataReader(MySqlDataReader reader)
        {
            GraphicCard temp = new GraphicCard();
        ...
        protected override void prepareCommandForInsert(MySqlCommand command, GraphicCard entity)
        {
        ...
        protected override void prepareCommandForUpdate(MySqlCommand command, int id, GraphicCard entity)
        {
            command.Parameters.AddWithValue("id", id);
