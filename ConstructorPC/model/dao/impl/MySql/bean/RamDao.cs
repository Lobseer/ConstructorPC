...
{
    public class RamDao : AbstractDao<Ram, int>, IRamDao
    {
        ...
        protected override Ram parseDataReader(MySqlDataReader reader)
        {
            Ram temp = new Ram();
        ...
        protected override void prepareCommandForInsert(MySqlCommand command, Ram entity)
        {
        ...
        protected override void prepareCommandForUpdate(MySqlCommand command, int id, Ram entity)
        {
